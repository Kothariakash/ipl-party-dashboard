...
def main():
    ...
    matches = [
        ...
        # {"id": "151774", "name": "RCB vs LSG"}
        #   {"id": "151785", "name": "MI vs PBKS"}
        # {"id": "151796", "name": "KKR vs GT"}
        # {"id": "151807", "name": "DC vs RCB"}
        # {"id": "151818", "name": "CSK vs SRH"}
        # {"id": "151829", "name": "RR vs KKR"}
        #   {"id": "151840", "name": "LSG vs PBKS"}    
        # {"id": "151845", "name": "GT vs MI"}   
            # {"id": "151856", "name": "SRH vs DC"}
            # {"id": "151867", "name": "RR vs LSG"}
                # {"id": "151878", "name": "CSK vs MI"}
        ...
        # {"id": "151943", "name": "PBKS vs RR"}
        # {"id": "151954", "name": "MI vs SRH"}
        # {"id": "151965", "name": "RCB vs GT"},
        # {"id": "151976", "name": "RR vs DC"}
        # {"id": "151987", "name": "MI vs CSK"}
        # {"id": "151998", "name": "KKR vs SRH"},
        # {"id": "152009", "name": "PBKS vs GT"}
        # {"id": "152020", "name": "LSG vs MI"}
        # {"id": "152031", "name": "DC vs CSK"}
        # {"id": "152042", "name": "PBKS vs SRH"}
        # {"id": "152053", "name": "LSG vs RCB"}
        # {"id": "152064", "name": "KKR vs DC"},
        # {"id": "152075", "name": "GT vs RR"},
        ...
        # {"id": "152141", "name": "PBKS vs MI"}
        # {"id": "152152", "name": "LSG vs CSK"}
        # {"id": "152163", "name": "KKR vs GT"},
        # {"id": "152174", "name": "RCB vs PBKS"}
        # {"id": "152185", "name": "DC vs RR"}
        # {"id": "152196", "name": "SRH vs CSK"}
        # {"id": "152207", "name": "LSG vs RR"}
